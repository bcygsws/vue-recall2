<template>
  <div class="keep_container">
    ...
    <!-- 只对组件Coma和Comb进行缓存，Comc不缓存；测试：向三个文本框中输入内容，观看变化；[]和正则表达式，需要动态绑定；
    字符串形式用逗号分隔多个组件名称 -->
 ...
 *
 * 被缓存的组件多出两个生命周期钩子activated和deactivated;
 * 1.被缓存组件初次渲染时，生命周期钩子执行顺序:
